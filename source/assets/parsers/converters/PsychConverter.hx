...
typedef PsychLegacySong =
{
	var song:String;
	var notes:Array<PsychLegacySection>;
...
// legacy psych, only support basic formats, not three players or that stuff
				...
				for (section in sections)
				{
					...
					for (note in notes)
					{
						...
						var gearNote:Array<Dynamic> = [
							...
							daNoteData,
							note[2],
							(gottaHitNote ? (section.gfSection ? chart.characters[2] : chart.characters[0]) : chart.characters[1])
						];
